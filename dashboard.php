...
<body>
<header>
        <img src="H&H.png" alt="H&H logo" width="90px">
		<h1>Welcome to H&H Store</h1>
		<nav>
			<ul>
				<li><a href="#">Home</a></li>
    ...
    <h4 style="color:lightgreen">Welcome, <?php echo $_SESSION['username']; ?>!</h4>
<main>
    <!-- Display products -->
    ...
    <i><p>Sony A7 IV - $600</p></i><br>

    <br>

    <li><b><i>WATCHES</i></b></li><br>
    <i><p>Available Soon...</p></i><br>
...
<section id="Our Services">
  ...
  <br>
    <section id="About Us">
			<u><h2>About Us</h2></u>
			<i><p>We are a leading provider of high-quality products and services.
                Pakistan’s Leading Store & Repair Service Provider H&H store Pakistan is the only reliable, trustworthy store in Pakistan that provides 
                authentic products with guarantee. We have a huge range of elctronics products be it the latest iPhone, iPad, or Macbook. Because of our finest team of professionals and the fastest and reliable services we have created a huge trust
 among our thousands of customers nationwide. Our store is a solely reliable Store in Pakistan.
            </p></i>
...
<section id="Contact Us">
    ...
    <footer>
		<p>Copyright © 2023 H&H Store</p>
        <a href="https://instagram.com" target="_main">Follow on IG </a><br>
        <a href="https://facebook.com" target="_main">Follow on Facebook</a><br>
	</footer>
</body>
</html>
